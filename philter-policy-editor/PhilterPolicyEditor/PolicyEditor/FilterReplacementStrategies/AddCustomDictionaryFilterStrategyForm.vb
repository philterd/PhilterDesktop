...
Public Class AddCustomDictionaryFilterStrategyForm

    Public Property FilterStrategy As CustomDictionaryFilterStrategy

    Public Sub New(FilterStrategy As CustomDictionaryFilterStrategy)
