...
Public Class AddZipCodeFilterStrategyForm

    Public Property FilterStrategy As ZipCodeFilterStrategy

    Public Sub New(FilterStrategy As ZipCodeFilterStrategy)
