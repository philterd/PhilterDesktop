...
Public Class AddHospitalAbbreviationFilterStrategyForm

    Public Property FilterStrategy As HospitalAbbreviationFilterStrategy

    Public Sub New(FilterStrategy As HospitalAbbreviationFilterStrategy)
