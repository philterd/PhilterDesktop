...
Public Class AddEmailAddressFilterStrategyForm

    Public Property FilterStrategy As EmailAddressFilterStrategy

    Public Sub New(FilterStrategy As EmailAddressFilterStrategy)
