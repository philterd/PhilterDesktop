...
Public Class AddFirstNameFilterStrategyForm

    Public Property FilterStrategy As FirstNameFilterStrategy

    Public Sub New(FilterStrategy As FirstNameFilterStrategy)
