...
Public Class AddCreditCardFilterStrategyForm

    Public Property FilterStrategy As CreditCardFilterStrategy

    Public Sub New(FilterStrategy As CreditCardFilterStrategy)
