...
Public Class AddPhoneNumberExtensionFilterStrategyForm

    Public Property FilterStrategy As PhoneNumberExtensionFilterStrategy

    Public Sub New(FilterStrategy As PhoneNumberExtensionFilterStrategy)
