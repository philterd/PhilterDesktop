...
Public Class AddIpAddressFilterStrategyForm

    Public Property FilterStrategy As IpAddressFilterStrategy

    Public Sub New(FilterStrategy As IpAddressFilterStrategy)
