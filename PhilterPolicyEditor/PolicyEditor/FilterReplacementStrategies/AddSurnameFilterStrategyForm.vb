...
Public Class AddSurnameFilterStrategyForm

    Public Property FilterStrategy As SurnameFilterStrategy

    Public Sub New(FilterStrategy As SurnameFilterStrategy)
