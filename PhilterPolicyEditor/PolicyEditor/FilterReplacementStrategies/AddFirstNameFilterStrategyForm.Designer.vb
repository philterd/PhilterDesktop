...
Partial Class AddFirstNameFilterStrategyForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.RedactRadioButton.Text = "Redact text identified as a first name."
        ...
        Me.RandomReplacementRadioButton.Text = "Replace text identified as a first name with a random value."
        ...
        Me.StaticReplaceRadioButton.Text = "Replace text identified as a first name with a static value."
    ...
    "onal is satisfied."
        '
        'AddFirstNameFilterStrategyForm
        '
        ...
        Me.Name = "AddFirstNameFilterStrategyForm"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "First Name Filter Strategy"
