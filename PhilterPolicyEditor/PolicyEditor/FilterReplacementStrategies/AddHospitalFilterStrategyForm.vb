...
Public Class AddHospitalFilterStrategyForm

    Public Property FilterStrategy As HospitalFilterStrategy

    Public Sub New(FilterStrategy As HospitalFilterStrategy)
