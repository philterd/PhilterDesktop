...
Public Class AddStateAbbreviationFilterStrategyForm

    Public Property FilterStrategy As StateAbbreviationFilterStrategy

    Public Sub New(FilterStrategy As StateAbbreviationFilterStrategy)
