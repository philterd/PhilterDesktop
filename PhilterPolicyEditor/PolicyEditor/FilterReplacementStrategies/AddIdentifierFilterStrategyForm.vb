...
Public Class AddIdentifierFilterStrategyForm

    Public Property FilterStrategy As IdentifierFilterStrategy

    Public Sub New(FilterStrategy As IdentifierFilterStrategy)
